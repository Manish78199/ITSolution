...
<p style={{width:"300px"}}><span className='brandlogo'>{props.Brand}</span> Help to Grow Your Bussines With Conulting  ,Web development And Software Development Services</p>
